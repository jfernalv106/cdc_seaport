...
func ConvertToFactura(src *model.FacturaTopic, factura *model.Factura) *model.Factura {
	...
	return &model.Factura{
		...
		ValorCambio:              func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.ValorCambio, 3)),
...
func ConvertToFacturaDetalle(
	...
	return &model.FacturaDetalle{
		...
		Descuento:       func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.Descuento, 2)),
		...
		Imo:             topic.Imo,
		Moneda:          topic.Moneda,
		Neto:            func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.Neto, 2)),
		Peso:            func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.Peso, 2)),
		Recargo:         func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.Recargo, 2)),
		Tarifa:          topic.Tarifa,
		Unidad:          topic.Unidad,
		UsuarioCR:       topic.UsuarioCR,
		ValorUnitario:   func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.ValorUnitario, 2)),
		Volumen:         func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.Volumen, 2)),
		IDFactura:       topic.IDFactura,
		NroPapeleta:     topic.NroPapeleta,
		Servicio:        topic.Servicio,
		Visaje:          topic.Visaje,
		NetoPeso:        func(v float64) *float64 { return &v }(utils.DecodeBinaryDecimal(topic.NetoPeso, 2)),
